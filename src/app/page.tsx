          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="space-y-6">
                ...
                <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 p-6 bg-white/10 backdrop-blur border border-white/15 hover:bg-white/15 transition-all duration-300" aria-label="Entrar em contato via WhatsApp">
                  <div className="w-12 h-12 bg-white/20 flex items-center justify-center group-hover:scale-110 transition-transform">
